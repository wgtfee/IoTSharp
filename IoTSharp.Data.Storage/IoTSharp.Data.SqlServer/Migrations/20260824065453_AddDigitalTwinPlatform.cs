        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RuntimeFormat = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ...
                    NodeIndex = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModelMetadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProcessingStatus = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    LicenseMetadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PreviewResourcePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SceneKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    RootAssetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    DraftPayload = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeSummary = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NodePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ModelResourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AssetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DeviceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SemanticId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    TargetKind = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    TargetPath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    TransformKind = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SceneId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SceneVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RouteKey = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    RouteType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
