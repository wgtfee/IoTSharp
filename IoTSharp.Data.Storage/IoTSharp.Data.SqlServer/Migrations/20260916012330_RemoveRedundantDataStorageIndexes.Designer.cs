...
namespace IoTSharp.Data.SqlServer.Migrations
{
    ...
    [Migration("20260916012330_RemoveRedundantDataStorageIndexes")]
    partial class RemoveRedundantDataStorageIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IoTSharp.Data.CollectionConfigurationVersion", b =>
                {
                    ...
                    b.ToTable("CollectionConfigVersions", (string)null);
                });
            ...
            modelBuilder.Entity("IoTSharp.Data.McpToolDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ProtectedHeaders")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("AISettingsId", "Enabled", "Deleted");

                    b.HasIndex("AISettingsId", "Name", "Deleted")
                        .IsUnique();

                    b.ToTable("McpToolDefinitions");
                });

            modelBuilder.Entity("IoTSharp.Data.McpToolInvocationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ArgumentKeys")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");
                    ...
                    b.HasIndex("AISettingsId", "StartedAt");

                    b.HasIndex("ToolDefinitionId", "StartedAt");

                    b.ToTable("McpToolInvocationLogs");
                });
            ...
            modelBuilder.Entity("IoTSharp.Data.ReleasePackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("TargetRuntimeType")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("TargetRuntimeVersion")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasIndex("PackageKey", "Version", "TargetRuntimeType", "Deleted");

                    b.ToTable("ReleasePackages");
                });

            modelBuilder.Entity("IoTSharp.Data.ReleasePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ConfirmationPolicy")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<int>("FailedTaskCount")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("RollbackPackageId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("SucceededTaskCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IoTSharp.Data.ReleaseReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EdgeTaskId");

                    b.HasIndex("GatewayId");

                    b.HasIndex("TenantId");

                    b.HasIndex("PlanId", "ReportedAt");

                    b.HasIndex("ReleaseTaskId", "ReportedAt");

                    b.HasIndex("TargetKey", "Status");

                    b.HasIndex("CustomerId", "TenantId", "Deleted");

                    b.ToTable("ReleaseReceipts");
                });

            modelBuilder.Entity("IoTSharp.Data.ReleaseTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PlanId", "BatchNo", "Status");
            ...
            modelBuilder.Entity("IoTSharp.Data.TwinActionFlow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CompiledPayload")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CompiledPlanHash")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasIndex("SceneId", "SceneVersionId", "FlowKey", "Deleted")
                        .IsUnique()
                        .HasFilter("[SceneVersionId] IS NOT NULL");

                    b.HasIndex("TenantId", "CustomerId", "Enabled", "Deleted");

                    b.ToTable("TwinActionFlows");
                });

            modelBuilder.Entity("IoTSharp.Data.TwinActionFlowEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("StepInstanceId")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.ToTable("TwinActionFlowEvents");
                });

            modelBuilder.Entity("IoTSharp.Data.TwinActionFlowRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RuntimePayload")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("SceneId", "Status", "UpdatedAt", "Deleted");

                    b.HasIndex("TenantId", "CustomerId", "IdempotencyKey", "Deleted")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL AND [CustomerId] IS NOT NULL");

                    b.ToTable("TwinActionFlowRuns");
                });

            modelBuilder.Entity("IoTSharp.Data.TwinActionFlowRunStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RunId", "StepInstanceId", "Deleted")
                        .IsUnique();

                    b.HasIndex("RunId", "Status", "UpdatedAt", "Deleted");

                    b.ToTable("TwinActionFlowRunSteps");
                });

            modelBuilder.Entity("IoTSharp.Data.TwinDeviceCommand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DeviceCycleId")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasIndex("RunId", "Status", "CreatedAt", "Deleted");

                    b.HasIndex("TenantId", "CustomerId", "CommandId", "Deleted")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL AND [CustomerId] IS NOT NULL");

                    b.ToTable("TwinDeviceCommands");
                });

            modelBuilder.Entity("IoTSharp.Data.TwinMaterialRuntime", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MaterialInstanceId")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.Property<string>("TransportUnitId")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasIndex("SceneId", "MaterialInstanceId", "Deleted")
                        .IsUnique();

                    b.HasIndex("TenantId", "CustomerId", "TransportUnitId", "Deleted");

                    b.ToTable("TwinMaterialRuntimes");
                });
            ...
            modelBuilder.Entity("IoTSharp.Data.TwinResourceReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OwnerRunId");

                    b.HasIndex("OwnerStepId");

                    b.HasIndex("TenantId", "CustomerId", "ReservationId", "Deleted")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL AND [CustomerId] IS NOT NULL");

                    b.HasIndex("TenantId", "CustomerId", "ResourceType", "ResourceId", "Status", "LeaseUntil", "Deleted");

                    b.ToTable("TwinResourceReservations");
                });
            ...
            modelBuilder.Entity("IoTSharp.Data.McpToolInvocationLog", b =>
                {
                    b.HasOne("IoTSharp.Data.McpToolDefinition", "ToolDefinition")
            ...
            modelBuilder.Entity("IoTSharp.Data.ReleasePlan", b =>
                {
                    ...
                    b.HasOne("IoTSharp.Data.ReleasePackage", "Package")
                        .WithMany()
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IoTSharp.Data.ReleasePackage", "RollbackPackage")
                        .WithMany()
                        .HasForeignKey("RollbackPackageId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("IoTSharp.Data.ReleaseReceipt", b =>
                {
                    ...
                    b.HasOne("IoTSharp.Data.ReleasePlan", "Plan")
                        .WithMany()
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("IoTSharp.Data.ReleaseTask", "ReleaseTask")
                        .WithMany("Receipts")
            ...
            modelBuilder.Entity("IoTSharp.Data.ReleaseTask", b =>
                {
                    ...
                    b.HasOne("IoTSharp.Data.EdgeTask", "EdgeTask")
                        .WithMany()
                        .HasForeignKey("EdgeTaskId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("IoTSharp.Data.TwinActionFlowEvent", b =>
                {
                    ...
                    b.HasOne("IoTSharp.Data.TwinActionFlowRun", "Run")
                        .WithMany("Events")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("IoTSharp.Data.TwinActionFlowRun", b =>
                {
                    b.HasOne("IoTSharp.Data.TwinActionFlow", "ActionFlow")
                        .WithMany()
            ...
            modelBuilder.Entity("IoTSharp.Data.TwinDeviceCommand", b =>
                {
                    ...
                    b.HasOne("IoTSharp.Data.TwinActionFlowRunStep", "Step")
                        .WithMany()
            ...
            modelBuilder.Entity("IoTSharp.Data.TwinResourceReservation", b =>
                {
                    ...
                    b.HasOne("IoTSharp.Data.TwinActionFlowRun", "OwnerRun")
                        .WithMany()
                        .HasForeignKey("OwnerRunId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("IoTSharp.Data.TwinActionFlowRunStep", "OwnerStep")
                        .WithMany()
                        .HasForeignKey("OwnerStepId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("OwnerRun");

                    b.Navigation("OwnerStep");
