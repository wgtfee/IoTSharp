        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ...
                    QualityProfile = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    AnimationReady = table.Column<bool>(type: "bit", nullable: false),
                    LicenseType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CommercialUseAllowed = table.Column<bool>(type: "bit", nullable: false),
                    ReferenceImagePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    ReferenceImageName = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ReferenceImageContentType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ReferenceImageSize = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Progress = table.Column<int>(type: "int", nullable: false),
                    Stage = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ProviderJobId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ProviderMetadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ErrorMessage = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    AttemptCount = table.Column<int>(type: "int", nullable: false),
                    ResultModelResourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
