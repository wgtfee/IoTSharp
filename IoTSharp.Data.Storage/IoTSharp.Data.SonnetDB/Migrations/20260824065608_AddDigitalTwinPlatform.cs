        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceKey = table.Column<string>(type: "STRING", maxLength: 128, nullable: false),
                    Name = table.Column<string>(type: "STRING", maxLength: 256, nullable: false),
                    SourceType = table.Column<string>(type: "STRING", maxLength: 64, nullable: false),
                    RuntimeFormat = table.Column<string>(type: "STRING", maxLength: 128, nullable: true),
                    OriginalFileName = table.Column<string>(type: "STRING", maxLength: 512, nullable: true),
                    StoragePath = table.Column<string>(type: "STRING", maxLength: 1024, nullable: true),
                    FileSize = table.Column<long>(type: "INT", nullable: false),
                    ContentHash = table.Column<string>(type: "STRING", maxLength: 128, nullable: true),
                    NodeIndex = table.Column<string>(type: "STRING", nullable: true),
                    ModelMetadata = table.Column<string>(type: "STRING", nullable: true),
                    ProcessingStatus = table.Column<string>(type: "STRING", maxLength: 64, nullable: false),
                    LicenseMetadata = table.Column<string>(type: "STRING", nullable: true),
                    ProductId = table.Column<Guid>(type: "STRING", nullable: true),
                    PreviewResourcePath = table.Column<string>(type: "STRING", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "STRING", nullable: false),
                    SceneKey = table.Column<string>(type: "STRING", maxLength: 128, nullable: false),
                    Name = table.Column<string>(type: "STRING", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "STRING", maxLength: 2048, nullable: true),
                    RootAssetId = table.Column<Guid>(type: "STRING", nullable: false),
                    Status = table.Column<string>(type: "STRING", maxLength: 64, nullable: false),
                    DraftPayload = table.Column<string>(type: "STRING", nullable: true),
                    PublishedVersionId = table.Column<Guid>(type: "STRING", nullable: true),
                    Revision = table.Column<long>(type: "INT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    CreatedBy = table.Column<string>(type: "STRING", maxLength: 256, nullable: true),
                    UpdatedBy = table.Column<string>(type: "STRING", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "STRING", nullable: false),
                    SceneId = table.Column<Guid>(type: "STRING", nullable: false),
                    Version = table.Column<int>(type: "INT", nullable: false),
                    SchemaVersion = table.Column<string>(type: "STRING", maxLength: 64, nullable: false),
                    Manifest = table.Column<string>(type: "STRING", nullable: true),
                    ManifestHash = table.Column<string>(type: "STRING", maxLength: 128, nullable: false),
                    ValidationReport = table.Column<string>(type: "STRING", nullable: true),
                    ChangeSummary = table.Column<string>(type: "STRING", maxLength: 1024, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    CreatedBy = table.Column<string>(type: "STRING", maxLength: 256, nullable: true),
                    TenantId = table.Column<Guid>(type: "STRING", nullable: true),
                    CustomerId = table.Column<Guid>(type: "STRING", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "STRING", nullable: false),
                    SceneId = table.Column<Guid>(type: "STRING", nullable: false),
                    SceneVersionId = table.Column<Guid>(type: "STRING", nullable: true),
                    BindingKey = table.Column<string>(type: "STRING", maxLength: 256, nullable: false),
                    ObjectId = table.Column<string>(type: "STRING", maxLength: 256, nullable: false),
                    NodePath = table.Column<string>(type: "STRING", maxLength: 1024, nullable: true),
                    ModelResourceId = table.Column<Guid>(type: "STRING", nullable: true),
                    AssetId = table.Column<Guid>(type: "STRING", nullable: true),
                    DeviceId = table.Column<Guid>(type: "STRING", nullable: true),
                    SemanticId = table.Column<string>(type: "STRING", maxLength: 256, nullable: true),
                    SourceKind = table.Column<string>(type: "STRING", maxLength: 64, nullable: false),
                    SourceKey = table.Column<string>(type: "STRING", maxLength: 256, nullable: true),
                    TargetKind = table.Column<string>(type: "STRING", maxLength: 64, nullable: false),
                    TargetPath = table.Column<string>(type: "STRING", maxLength: 512, nullable: true),
                    TransformKind = table.Column<string>(type: "STRING", maxLength: 64, nullable: true),
                    TransformConfig = table.Column<string>(type: "STRING", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SceneId = table.Column<Guid>(type: "STRING", nullable: false),
                    SceneVersionId = table.Column<Guid>(type: "STRING", nullable: true),
                    RouteKey = table.Column<string>(type: "STRING", maxLength: 256, nullable: false),
                    Name = table.Column<string>(type: "STRING", maxLength: 256, nullable: false),
                    RouteType = table.Column<string>(type: "STRING", maxLength: 64, nullable: false),
                    GraphPayload = table.Column<string>(type: "STRING", nullable: true),
                    Revision = table.Column<long>(type: "INT", nullable: false),
                    Enabled = table.Column<bool>(type: "BOOL", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "DATETIME", nullable: false),
