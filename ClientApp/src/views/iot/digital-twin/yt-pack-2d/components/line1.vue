...
defineOptions({ name: 'YtPackLine1' });
...
const smallConveyerConfigList = [
        ...
        {name: 'L2_XGD_0422', textLocation: 'd', x: 1360, y: 60, width: 80, height: 40, rx: 5, border: 'ud', direction: 'r',},
        {name: 'L2_XGD_0423', textLocation: 'u', x: 1440, y: 60, width: 40, height: 40, rx: 5, border: 'u', direction: 'r',},
        {name: 'L2_XGD_042', textLocation: 'u', x: 1480, y: 60, width: 600, height: 40, rx: 5, border: 'ud', direction: 'r',},
        {name: 'L2_XGD_0424', textLocation: 'u', x: 2080, y: 60, width: 80, height: 40, rx: 5, border: 'ur', direction: 'd',},

        {name: 'L2_XGD_043', textLocation: 'r', x: 1440, y: 100, width: 40, height: 460, rx: 5, border: 'lr', direction: 'u',},
        {name: 'L2_XGD_0431', textLocation: 'd', x: 1440, y: 560, width: 40, height: 40, rx: 5, border: 'ld', direction: 'u',},

        {name: 'L2_XGD_0441', textLocation: 'u', x: 1480, y: 560, width: 200, height: 40, rx: 5, border: 'ud', direction: 'l',}, 
