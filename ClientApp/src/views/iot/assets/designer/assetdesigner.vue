<template>
    <div class="workflow-container">
      ...
      <shapemenu :dropdown="state.dropdownNode" ref="contextmenunodeRef" @onshapeclickcommand="ongatewayclickcommand">
      </shapemenu>
  
      <edgemenu :dropdown="state.dropdownNode" ref="contextmenugatewayRef"
        @onedgeopencommand="onconnectoropencommand">
      </edgemenu>
      <drawercontainer ref="drawerRef" @submit="onsubmit" />
    </div>
  </template>
  <script lang="ts" setup>
  import { AssetDesignerState } from "./models/assetdesignermodel";
  import { useTagsViewRoutes } from "/@/stores/tagsViewRoutes";
  import { useThemeConfig } from "/@/stores/themeConfig";
  import { Graph, Edge, Shape, NodeView } from "@antv/x6";
  import { Device } from "./shapes/device";
  import shapemenu from "./contextmenu/shapemenu.vue";
  import edgemenu from "./contextmenu/edgemenu.vue";
...
import { ElMessage } from "element-plus";
  ...
  const state = reactive<AssetDesignerState>({
    dropdownNode: {
      x: '', y: ''
        ...
        profile: {
          ...
          command: {
            ...
            contextmenu: [
              ...
              { command: 'editmodbusprop', txt: "资产属性", icon: "ele-Edit" },
              { command: 'editmodbusprop', txt: "资产遥测", icon: "ele-Edit" },
            ],
          },
          mappings: []
        }
